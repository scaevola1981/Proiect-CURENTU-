...
import styles from './ambalare.module.css'; // You'll need to create this CSS module
...
const Ambalare = () => {
  ...
  // Încarcă datele despre containere la montarea componentei
  useEffect(() => {
    // Obține containerele din localStorage
    ...
    // Încarcă stocul de ambalaje
    const stocSalvat = localStorage.getItem('stocAmbalaje');
    if (stocSalvat) {
      setStocAmbalaje(JSON.parse(stocSalvat));
    }

    // Încarcă jurnalul de ambalare
  ...
  // Calculează necesarul de materiale pentru ambalare
  const calculeazaNecesar = (container, optiuni) => {
    ...
    if (tipAmbalaj === 'sticla') {
      ...
      // Calculează numărul de keg-uri necesar
    ...
    setDetaliiAmbalare(prevState => ({ ...prevState, necesarCalculat: necesar }));
    return necesar;
  };

  // Funcție pentru executarea ambalării
  const executaAmbalarea = () => {
    ...
    // Actualizează stocul de ambalaje
    const stocNou = { ...stocAmbalaje };
    
    if (necesar.tipAmbalaj === 'sticla') {
      // Scade stocul de sticle, dopuri și cutii
      stocNou.sticle[necesar.volumAmbalaj] = Math.max(
        0, stocNou.sticle[necesar.volumAmbalaj] - necesar.numarSticle
      );
      stocNou.dopuri = Math.max(0, stocNou.dopuri - necesar.numarDopuri);
      stocNou.cutii[necesar.sticlePerCutie] = Math.max(
        0, stocNou.cutii[necesar.sticlePerCutie] - necesar.numarCutii
      );
      
      // Scade stocul de etichete dacă e cazul
      ...
      // Scade stocul de keg-uri
      stocNou.kegs[necesar.volumAmbalaj] = Math.max(
        0, stocNou.kegs[necesar.volumAmbalaj] - necesar.numarKeguri
      );
    }
  ...
  // Funcție pentru adăugarea de stoc
    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.sectionsContainer}>
            ...
            {containere.length === 0 ? (
              ...
              <div className={styles.containereGrid}>
                {containere.map((container) => (
                  <div 
                    key={container.id}
                    className={`${styles.containerCard} ${containerSelectat?.id === container.id ? styles.containerSelectat : ''}`}
                  ...
                  >
                    ...
                    <div className={styles.containerContent}>
                      ...
                      <p><strong>{container.retetaNume}</strong></p>
          ...
          {/* Secțiunea cu opțiuni de ambalare */}
          {containerSelectat && (
            <div className={styles.section}>
                ...
                <>
                  <div className={styles.formGroup}>
                    ...
                    <select 
                      ...
                      onChange={(e) => actualizeazaOptiuni('volumAmbalaj', parseFloat(e.target.value))}
                  ...
                  <div className={styles.formGroup}>
                    ...
                    <select 
                      ...
                      onChange={(e) => actualizeazaOptiuni('sticlePerCutie', parseInt(e.target.value))}
                      className={styles.select}
                    >
                    ...
                    <div className={styles.checkboxGroup}>
                      <label>
                        <input 
                          ...
                          onChange={(e) => actualizeazaOptiuni('etichetaFata', e.target.checked)}
                        /> 
                        Etichetă față
                      </label>
                      <label>
                        <input 
                          ...
                          onChange={(e) => actualizeazaOptiuni('etichetaSpate', e.target.checked)}
                        /> 
                        Etichetă spate
                      </label>
                    </div>
              ...
              {detaliiAmbalare.necesarCalculat && (
                <div className={`${styles.necesarContainer} ${!detaliiAmbalare.necesarCalculat.stocSuficient ? styles.stocInsuficient : ''}`}>
                  <h3>Necesar materiale:</h3>
                  
                  {detaliiAmbalare.tipAmbalaj === 'sticla' ? (
                    <div>
                      <p>Sticle {detaliiAmbalare.volumAmbalaj}L: <strong>{detaliiAmbalare.necesarCalculat.numarSticle}</strong> buc</p>
                      <p>Dopuri: <strong>{detaliiAmbalare.necesarCalculat.numarDopuri}</strong> buc</p>
                      <p>Cutii de {detaliiAmbalare.sticlePerCutie}: <strong>{detaliiAmbalare.necesarCalculat.numarCutii}</strong> buc</p>
                      {detaliiAmbalare.etichetaFata && (
                        <p>Etichete față: <strong>{detaliiAmbalare.necesarCalculat.numarEticheteFata}</strong> buc</p>
                      )}
                      {detaliiAmbalare.etichetaSpate && (
                        <p>Etichete spate: <strong>{detaliiAmbalare.necesarCalculat.numarEticheteSpate}</strong> buc</p>
                      )}
                    </div>
                  ) : (
                    <div>
                      <p>Keg-uri {detaliiAmbalare.volumAmbalaj}L: <strong>{detaliiAmbalare.necesarCalculat.numarKeguri}</strong> buc</p>
                    </div>
                  )}
                  ...
                  <div className={styles.stockFormColumn}>
                    ...
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        onBlur={(e) => e.target.value && adaugaStoc('sticle', 0.33, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      <label>0.5L:</label>
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('sticle', 0.5, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      <label>0.75L:</label>
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('sticle', 0.75, e.target.value)}
                      />
                    </div>
                  </div>
                  ...
                  <div className={styles.stockFormColumn}>
                    ...
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('kegs', 10, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      <label>20L:</label>
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('kegs', 20, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      <label>30L:</label>
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('kegs', 30, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      <label>50L:</label>
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('kegs', 50, e.target.value)}
                      />
                    </div>
                  </div>
                  ...
                  <div className={styles.stockFormColumn}>
                    ...
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('cutii', 6, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('cutii', 12, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('cutii', 24, e.target.value)}
                      />
                    </div>
                  </div>
                  ...
                  <div className={styles.stockFormColumn}>
                    ...
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('dopuri', null, e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('etichete', 'fata', e.target.value)}
                      />
                    </div>
                    <div className={styles.stockFormItem}>
                      ...
                      <input 
                        ...
                        min="0" 
                        className={styles.smallInput}
                        onBlur={(e) => e.target.value && adaugaStoc('etichete', 'spate', e.target.value)}
                      />
                    </div>
                  </div>
                </div>
          ...
          {/* Secțiunea cu jurnalul de ambalare */}
          <div className={styles.section}>
            <div className={styles.sectionHeader}>
